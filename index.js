 ...
 * Homepage: https://shopilo.it/negozi/udemy.com
 */

const SHOPILO_URL = "https://shopilo.it/negozi/udemy.com";
const STORE_NAME  = "Udemy";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-udemy)" }
  });
