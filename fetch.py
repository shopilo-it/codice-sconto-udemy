#!/usr/bin/env python3
"""
Recupero codici sconto Udemy da shopilo.it
Sursa: https://shopilo.it/negozi/udemy.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/udemy.com"
STORE_NAME = "Udemy"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Udemy da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-udemy)"
    }
    try:
